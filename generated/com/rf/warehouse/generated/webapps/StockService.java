 ...
 * 
 */
@WebServiceClient(name = "StockService", targetNamespace = "http://warehouse.rf.com/", wsdlLocation = "war/WEB-INF/wsdl/stock.wsdl")
    ...
    extends Service
{
    ...
    static {
        STOCKSERVICE_WSDL_LOCATION = com.rf.warehouse.generated.webapps.StockService.class.getResource("war/WEB-INF/wsdl/stock.wsdl");
        WebServiceException e = null;
        if (STOCKSERVICE_WSDL_LOCATION == null) {
            e = new WebServiceException("Cannot find 'war/WEB-INF/wsdl/stock.wsdl' wsdl. Place the resource correctly in the classpath.");
        }
